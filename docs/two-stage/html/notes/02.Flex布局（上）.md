...
父元素设置为： `display: flex` 以后，其子元素的 `float` 、`clear` 和 `vertical-align` 属性将失效。
...
- `flex-wrap: nowrap`
  ...
  ***nowrap*** 表示不换行，即，flex 元素的所有子元素，都要在同一行。
  ...
  ![flex-08](/images/flex-08.png)

- `flex-wrap: wrap`

  表示换行，换行的方向是沿交叉轴方向换行。形如：

  ![flex-09](/images/flex-09.png)
...
**align-content** 属性和 flex-wrap 属性有点关系。当 `flex-wrap: wrap` 和 `flex-wrap:wrap-reverse` 时，如果 Flex 元素的子元素（item）多到一行/一列放不下时，会出现折行的情况。这时，逻辑上就相当于有了多根平行的主轴。
...
- `align-content: flex-start`
  ...
  ![align-content-flex-start.png](/images/align-content-flex-start.png)
...
- `align-content: flex-end`
  ...
  ![align-content-flex-end.png](/images/align-content-flex-end.png)
...
- `align-content: space-between`
  ...
  ![align-content-between.png](/images/align-content-between.png)
...
- `align-content: space-around`
  ...
  ![align-content-around.png](/images/align-content-around.png)
