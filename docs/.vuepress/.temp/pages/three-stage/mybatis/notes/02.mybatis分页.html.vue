<template><h1 id="分页" tabindex="-1"><a class="header-anchor" href="#分页" aria-hidden="true">#</a> 分页</h1>
<p>Mybatis 中实现分页功能有三种途径：</p>
<ul>
<li>RowBounds 分页（不建议使用）</li>
<li>Example 分页（简单情况可用)</li>
<li>PageHelper 分页</li>
</ul>
<h2 id="_1-rowbounds-分页" tabindex="-1"><a class="header-anchor" href="#_1-rowbounds-分页" aria-hidden="true">#</a> 1. RowBounds 分页</h2>
<p>MyBatis 本身通过 RowBounds 对象提供了分页功能，你仅需为你的 dao 的查询方法多添加 RowBounds 类型的一个参数，并且不需要对配置文件做任何调整。</p>
<blockquote>
<p>RowBounds 也称原生分页、逻辑分页。</p>
</blockquote>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>但是这种分页是一种 <strong>逻辑分页</strong>，MyBatis 并未使用 <strong>limit</strong> 子句，查询的仍是 <em>所有数据</em>，只是它仅给你“看”到了所有数据中的一部分，逻辑分页虽然完成了分页功能，但是它并未通过分页功能的对性能问题有所提升。</p>
<h2 id="_2-pagehelper-分页" tabindex="-1"><a class="header-anchor" href="#_2-pagehelper-分页" aria-hidden="true">#</a> 2. PageHelper 分页</h2>
<p>PageHelper 是一款被广泛使用的 MyBatis 插件。它通过 Mybatis 的插件机制，巧妙地通过机制，在不需要配置文件（不需要写 limit 子句）的情况下，动态去修改你所执行的 SQL，在其后动态添加 limit 子句。</p>
<p>为了使用 PageHelper 需要引入相应的包：</p>
...
<p>pagehelper 有 4.x 和 5.x 两个版本，用法有所不同，并不是向下兼容，同样的配置在使用 4.x 或 5.x 版本中可能会报错。例如，上面的 <code>helperDialect</code> 就是 5.x 中的配置，在 4.x 中使用的是 <code>dialect</code> 。</p>
</div>
<p>如果 Mybatis 整合进了 Spring，除了上述这样配置外，还可以将相应的注册-配置工作就在 Spring 的配置文件中进行：</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>bean</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>sqlSessionFactory<span class="token punctuation">"</span></span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>org.mybatis.spring.SqlSessionFactoryBean<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
  ...
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>property</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>bean</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br></div></div><p><strong>插件的属性配置</strong>：</p>
<ul>
<li>
<p>helperDialect</p>
<p>用于指明底层数据库类型：oracle, mysql, mariadb, sqlite, hsqldb, postgresql, db2, sqlserver, informix, h2, sqlserver2012, derby</p>
</li>
<li>
<p>reasonable</p>
<p>是否启用『合理化』功能</p>
<p>启用（true）时，如果 <code>pageNum &lt; 1</code>，会返回第一页内容；如果 <code>pageNum &gt; pages</code>，会返回查询最后一页。</p>
<p>禁用（false）时，超出合理的范围会直接返回空数据。</p>
</li>
</ul>
<p>在使用 PageHelper 时，PageHelper 提供了两种风格来描述分页：</p>
<p>pageNum / pageSize 组合</p>
<p>offset / limit 组合</p>
<p>插件作者建议推荐方式</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>这种风格实际上是在模拟 “人的语气” 。</p>
<p>在你调用查询方法之前，调用 PageHelper 的上述两个方法中的任意一个，都可激活 PageHelper 插件的分页功能，使其动态地『帮』你修改SQL语句（添加 <em>limit</em> 子句）。而 Mybatis 的 select 返回的结果就返回的是一页数据。</p>
...
<p>由于 PageHelper 插件的实现涉及到 ThreadLocal 原理，这导致一旦 PageHelper 生产了一个分页参数（一个内部使用的 Page 对象），但是没有被消费，这个参数就会一直保留在这个线程的 ThreadLocal 中。当这个线程再次被使用时，就可能导致不该分页的方法去消费这个分页参数，这就产生了莫名其妙的分页。所以，分页参数的创建代码，和查询方法的调用代码，必须 “<strong>紧密的在一起</strong>” 。</p>
</div>
<p>PageHelper 插件流行的原因在于，它不仅仅能实现分页功能，而且还进一步封装了页面上的『<strong>分页导航条</strong>』所需要的所有相关信息。</p>
<p>在使用 PageHelper 的过程中，我们已经提供了 4 个关键数据：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token class-name">PageHelper</span><span class="token punctuation">.</span><span class="token function">startPage</span><span class="token punctuation">(</span><span class="token number">4</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// 当前页的页号, 每页显示的数据量</span>
<span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span>
<span class="token class-name">PageInfo</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token class-name">Employee</span><span class="token punctuation">></span></span> info <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">PageInfo</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token punctuation">></span></span><span class="token punctuation">(</span>list<span class="token punctuation">,</span> <span class="token number">5</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// 查询结果, 导航栏上导航数字的个数</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>在创建了 PageInfo 之后便可以使用它：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">// &lt;&lt; &lt; 2 3 [4] 5 6 > >></span>
...
log<span class="token punctuation">.</span><span class="token function">info</span><span class="token punctuation">(</span><span class="token string">"共有 {} 条数据"</span><span class="token punctuation">,</span> info<span class="token punctuation">.</span><span class="token function">getTotal</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><h2 id="_3-pageinfo-对象属性描述" tabindex="-1"><a class="header-anchor" href="#_3-pageinfo-对象属性描述" aria-hidden="true">#</a> 3. PageInfo 对象属性描述</h2>
<table>
<thead>
<tr>
...
<tbody>
<tr>
<td style="text-align:left">int pageNum</td>
<td style="text-align:left">当前页</td>
<td style="text-align:left">比如，当前为第 <code>5</code> 页</td>
</tr>
<tr>
<td style="text-align:left">int pageSize</td>
<td style="text-align:left">每页的数量</td>
<td style="text-align:left">比如，每页（计划/预期）显示 <code>10</code> 条数据</td>
</tr>
<tr>
<td style="text-align:left">int size</td>
<td style="text-align:left">当前页的数量</td>
<td style="text-align:left">比如，以 98 条总数据为例，每页最多显示 <code>10</code> 条（最后一页显示 <code>8</code> 条数据）</td>
</tr>
<tr>
<td style="text-align:left">int startRow</td>
<td style="text-align:left">当前页面第一个元素在数据库中的行号</td>
<td style="text-align:left">比如，以 98 条总数据的最后一页为例，第一条数据是第 <code>91</code> 条</td>
</tr>
<tr>
<td style="text-align:left">int endRow</td>
<td style="text-align:left">当前页面最后一个元素在数据库中的行号</td>
<td style="text-align:left">比如，以 98 条总数据的最后一页为例，最后一条数据是第 <code>98</code> 条</td>
</tr>
<tr>
<td style="text-align:left">int pages</td>
<td style="text-align:left">总页数</td>
<td style="text-align:left">比如，以 98 条总数据为例，每页显示 10 条（其中最后一页 8 条），因此共 <code>10</code> 页</td>
</tr>
<tr>
<td style="text-align:left">int prePage</td>
<td style="text-align:left">前一页</td>
<td style="text-align:left">比如，当前是第 5 页，所以前一页为 <code>4</code></td>
</tr>
<tr>
<td style="text-align:left">int nextPage</td>
<td style="text-align:left">下一页</td>
<td style="text-align:left">比如，当前是第 5 页，所以下一页为 <code>6</code></td>
</tr>
<tr>
<td style="text-align:left">boolean isFirstPage</td>
<td style="text-align:left">是否为第一页</td>
<td style="text-align:left">比如，当前是第 5 页，不是第 1 页，所以为 <code>false</code></td>
</tr>
<tr>
<td style="text-align:left">boolean isLastPage</td>
<td style="text-align:left">是否为最后一页</td>
<td style="text-align:left">比如，当前是第 5 页，不是最后 1 页，所以为 <code>false</code></td>
</tr>
<tr>
<td style="text-align:left">boolean hasPreviousPage</td>
<td style="text-align:left">是否有前一页</td>
<td style="text-align:left">比如，当前是第 5 页，有前一页，所以为 <code>true</code></td>
</tr>
<tr>
<td style="text-align:left">boolean hasNextPage</td>
<td style="text-align:left">是否有下一页</td>
<td style="text-align:left">比如，当前是第 5 页，有后一页，所以为 <code>true</code></td>
</tr>
<tr>
<td style="text-align:left">int navigatePages</td>
<td style="text-align:left">导航页码数</td>
<td style="text-align:left">比如，页面导航栏显示 [3 4 5 6 7] 共 <code>5</code> 个数字</td>
</tr>
<tr>
<td style="text-align:left">int[] navigatepageNums</td>
<td style="text-align:left">所有导航页号</td>
<td style="text-align:left">比如，页面导航栏显示 <code>[3 4 5 6 7]</code> 这 5 个数字</td>
</tr>
<tr>
<td style="text-align:left">int navigateFirstPage</td>
<td style="text-align:left">导航条上的第一页</td>
<td style="text-align:left">比如，页面导航栏显示 [3 4 5 6 7] 时，第一页是第 <code>3</code> 页</td>
</tr>
<tr>
<td style="text-align:left">int navigateLastPage</td>
<td style="text-align:left">导航条上的最后一页</td>
<td style="text-align:left">比如，页面导航栏显示 [3 4 5 6 7] 时，第一页是第 <code>7</code> 页</td>
</tr>
</tbody>
</table>
</template>
