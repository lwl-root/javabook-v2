<template><h1 id="java-8-nashorn-javascript" tabindex="-1"><a class="header-anchor" href="#java-8-nashorn-javascript" aria-hidden="true">#</a> Java 8 Nashorn JavaScript</h1>
<p>从 JDK 1.8 开始，<strong>Nashorn</strong> 取代 Rhino（JDK 1.6, JDK1.7）成为 Java 的嵌入式 JavaScript 引擎。Nashorn 完全支持 ECMAScript 5.1 规范以及一些扩展。它使用基于 JSR 292 的新语言特性，其中包含在 JDK 7 中引入的 invokedynamic ，将 JavaScript 编译成 Java 字节码。</p>
<blockquote>
<p>Nashorn JavaScript Engine 在 Java 15 已经不可用了。</p>
</blockquote>
<h2 id="jjs-交互式编程" tabindex="-1"><a class="header-anchor" href="#jjs-交互式编程" aria-hidden="true">#</a> jjs 交互式编程</h2>
<p><strong>jjs</strong> 是个基于 Nashorn 引擎的命令行工具。它接受一些 JavaScript 源代码为参数，并且执行这些源代码。</p>
<p>打开控制台，输入以下命令：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>$ jjs
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><h2 id="传递参数" tabindex="-1"><a class="header-anchor" href="#传递参数" aria-hidden="true">#</a> 传递参数</h2>
<p>打开控制台，输入以下命令：</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>打开控制台，输入以下命令：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>$ jjs sample<span class="token punctuation">.</span>js
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>以上程序输出结果为：</p>
