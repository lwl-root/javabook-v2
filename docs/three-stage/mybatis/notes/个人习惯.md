...
通常认为这不是一个很好的习惯，因为在 Maven 项目中，.xml 和 .properties 一类的资源文件应该统一放在 &lt;font color="blue"&gt;&lt;b&gt;resources&lt;/b&gt;&lt;/font&gt; 目录下，而非放在代码目录（ `java` ）下。
...
::: tip 提示
如果你对 &lt;font color="blue"&gt;&lt;b&gt;classpath&lt;/b&gt;&lt;/font&gt; 的概念很熟悉的话，那么你很显然会立刻想到到哪里去看、去验证是否真的没有 mapper 文件。
:::
...
## 3. 解决办法
在 pom.xml 文件的 &lt;font color="blue"&gt;&lt;b&gt;&lt;build&gt;...&lt;/build&gt;&lt;/b&gt;&lt;/font&gt; 中添加如下配置：
```xml
<resources>
    <resource>
