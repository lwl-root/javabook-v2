...
另外，**@WebAppConfiguration 必须与 @ContextConfiguration 结合使用。**@ContextConfiguration 则是用于指定 Spring 配置文件或配置类的。

```java
// @RunWith(SpringJUnit4ClassRunner.class) // use junit 4
@ExtendWith(SpringExtension.class)  // use junit 5
@WebAppConfiguration
