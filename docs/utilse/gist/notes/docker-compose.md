...
::: code-group-item docker 命令版
  ...
  ```
:::
::: code-group-item docker-compose 版
...
services:
  ...
  ```
:::
::: code-group-item custom.properties
  ```properties
...
#management.metrics.export.influx.compressed=true
  ```
:::
::: code-group-item nacos-mysql.sql
```sql
/*
